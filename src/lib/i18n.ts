...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    mazeboard: {
      ...
      bypass_desc: "Bypass Key must be activated first by clicking Use Bypass. Once active, move directly towards a firewall wall to break it!",
  ...
  id: {
    ...
    mazeboard: {
      ...
      bypass_title: "VALIDATOR BYPASS KEY",
      bypass_desc: "Bypass Key harus diaktifkan terlebih dahulu dengan menekan tombol Gunakan Bypass. Setelah aktif, arahkan gerakan Anda langsung ke dinding untuk mendobrak firewall!",
